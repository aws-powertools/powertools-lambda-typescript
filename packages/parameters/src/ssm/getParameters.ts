 ...
 * ```
 * 
 * This object accepts the same options as the [AWS SDK v3 for JavaScript SSM getParameterssByPath command](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/clients/client-ssm/interfaces/getParameterssbypathcommandinput.html).
 * 
