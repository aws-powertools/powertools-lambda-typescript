...
class Router {
   ...
   *
   * This method can be used as a direct function call or as a method decorator.
   *
   * @example
   * ```ts
   ...
   * @param handler - The function to handle the Query. Receives the payload as the first argument.
