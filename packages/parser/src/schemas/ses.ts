...
const SesReceipt = z.object({
  ...
  spamVerdict: SesReceiptVerdict.optional(),
  virusVerdict: SesReceiptVerdict.optional(),
  spfVerdict: SesReceiptVerdict.optional(),
  dmarcVerdict: SesReceiptVerdict.optional(),
  action: z.object({
    type: z.enum(['Lambda']),
