...
For more information on how to use the `validate` function, please refer to the [documentation](https://docs.aws.amazon.com/powertools/typescript/latest/features/validation).
