...
| [Idempotency](./utilities/idempotency.md) | Convert your Lambda functions into idempotent operations which are safe to retry.                                                            |
| [Batch Processing](./utilities/batch.md)  | Handle partial failures when processing batches from Amazon SQS, Amazon Kinesis Data Streams, and Amazon DynamoDB Streams.                   |
