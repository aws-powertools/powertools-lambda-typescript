 ...
 *
 * As a Powertools for AWS Lambda (TypeScript) user you probably won't be using this class directly, in fact if you use other Powertools for AWS Lambda (TypeScript) utilities the cold start heuristic found here is already used to:
