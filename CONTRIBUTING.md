...
1. Create a virtual environment and install dependencies:
   ...
   The script looks for a `python3.14`-style executable. If your interpreter is only available under another name, for example in a conda environment, point the script at it with `PYTHON=python npm run docs:local:setup`.
